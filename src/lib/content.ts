...
/**
 * Resolves a URL segment to a row for berita detail pages.
 *
 ...
 * `news.slug` is an optional add-on, not part of the base schema. When
 ...
 */
export async function loadIndex(table: 'news'): Promise<IndexRow[]> {
