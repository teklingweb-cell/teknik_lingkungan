...
const ANGGOTA: Anggota[] = [
  { nama: 'Prof. Ir. Eko Siswoyo, S.T., M.Sc.ES. Ph.D., IPU', unsur: 'Asosiasi', instansi: 'BAKERMA TL' },
  { nama: 'Arieza Akbary Trieputra, S.T., M.Sc.', unsur: 'Asosiasi', instansi: 'IATPI' },
  { nama: 'Prof. Ali Masduqi, S.T., M.T.', unsur: 'Akademisi', instansi: 'Teknik Lingkungan ITS' },
  { nama: 'Novi Dharmawan, S.T.', unsur: 'BUMD', instansi: 'Perumda Air Minum Tirta Khatulistiwa Pontianak' },
  { nama: 'Agus Setiadi, S.T.', unsur: 'Praktisi Industri', instansi: 'PT. Borneo Alumina Indonesia' },
  { nama: 'Aldice Sekar Arum R., S.T.', unsur: 'Praktisi Industri', instansi: 'PT Cita Mineral Investindo, Tbk' },
  { nama: 'Ir. Dede Subandi, S.T.', unsur: 'Konsultan Lingkungan', instansi: 'CV. Nabila Reka Konsultan' },
  { nama: 'Dwi Farastika, S.T., M.Sc.', unsur: 'Lembaga Kerjasama Pemerintah', instansi: 'Office of Deutsche Gesellschaft fur international Zusammenarbeit (GIZ)' },
  { nama: 'Ir. Ivan Andri Gunawan, S.T., M.T.', unsur: 'Alumni Program Studi S-1 Teknik Lingkungan Universitas Tanjungpura', instansi: 'Universitas Panca Bhakti Pontianak' },
];
