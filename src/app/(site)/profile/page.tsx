        ...
        <div className="container">
          <div className="stats-grid" style={{ padding: '40px 24px' }}>
            ...
            <div className="stat-item">
              ...
              <div className="stat-label">Dosen</div>
            </div>
            <div className="stat-item">
              <div className="stat-value">Baik Sekali</div>
            ...
            <div className="fade-up delay-1">
              <div style={{ background: 'var(--navy)', borderRadius: '20px', padding: '40px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                  ...
                  <div>
                    <div style={{ fontFamily: 'var(--font-display)', fontSize: '1rem', color: 'var(--cream)', marginBottom: '4px' }}>Akreditasi Baik Sekali</div>
                    <div style={{ fontSize: '0.8rem', color: 'rgba(242,245,239,0.5)', fontFamily: 'var(--font-body)' }}>Berlaku hingga 11 Januari 2027</div>
                  </div>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
