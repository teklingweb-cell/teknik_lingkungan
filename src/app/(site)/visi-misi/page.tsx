...
export default function VisiMisiPage() {
  return (
    <>
            ...
            <div className="grid-2">
              <div className="vm-card vm-card-prodi">
                ...
                <p className="vm-quote-lg">
                  "Mengembangkan keilmuan Teknik Lingkungan yang unggul, di bidang Rekayasa Infrastruktur, Pengendalian Pencemaran, dan Manajemen Lingkungan berbasis kearifan lokal untuk mendukung pembangunan berkelanjutan di wilayah tropis dan perbatasan."
                </p>
              </div>
              <div className="vm-card vm-card-prodi soft">
                ...
                <div className="vm-list lg">
                  <div className="vm-item lg">
                    ...
                    Menyelenggarakan pendidikan dan pembelajaran yang inovatif, kreatif, dan berorientasi dalam bidang teknik lingkungan untuk menghasilkan lulusan profesional, berintegritas, dan berdaya saing.
                  </div>
                  <div className="vm-item lg">
                    <span className="vm-num-circle">2</span>
                    Menyelenggarakan penelitian di bidang lingkungan yang menghasilkan inovasi dan teknologi dalam pengelolaan kualitas lingkungan dan pencemaran untuk mendukung pembangunan berkelanjutan, khususnya di wilayah tropis dan perbatasan.
                  </div>
                  <div className="vm-item lg">
                    <span className="vm-num-circle">3</span>
                    Menyelenggarakan pengabdian kepada masyarakat berbasis penerapan teknologi lingkungan tepat guna untuk meningkatkan kualitas hidup masyarakat dan kelestarian lingkungan.
                  </div>
                  <div className="vm-item lg">
                  </div>
                  <div className="vm-item lg">
      ...
      {/* VISI KEILMUAN — dari PDF hal. 6 */}
      <section className="section">
        <div className="container">
          <div className="fade-up" style={{ marginBottom: '40px' }}>
            <div className="section-tag">— Orientasi Pengembangan Ilmu</div>
            <h2 className="section-title">Visi Keilmuan</h2>
            <div className="gold-divider" />
          </div>
          <div className="fade-up delay-1">
            <div className="vm-card vm-card-prodi" style={{ maxWidth: 720 }}>
              <div className="vm-icon">VK</div>
              <h3 className="vm-card-title">Visi Keilmuan Jurusan</h3>
              <p className="vm-quote-lg">
                &ldquo;Menjadi pusat pengembangan Teknik Lingkungan berkelanjutan berbasis kearifan lokal di wilayah tropis dan perbatasan.&rdquo;
              </p>
            </div>
          </div>
        </div>
      ...
      {/* PROFIL LUARAN — dari PDF hal. 11–12 */}
      <section className="section bg-white">
        <div className="container">
          <div className="fade-up" style={{ marginBottom: '40px' }}>
            <div className="section-tag">— Kompetensi Lulusan</div>
            <h2 className="section-title">Profil &amp; Penguasaan Pengetahuan Lulusan</h2>
            <p style={{ color: 'rgba(45,58,46,0.5)', fontFamily: 'var(--font-body)', fontSize: '0.9rem', marginTop: 8 }}>
              Seorang Sarjana Teknik Lingkungan diharapkan mampu berkarya dan menjawab tantangan di bidang:
            </p>
          </div>

          {/* Tantangan global yang dijawab */}
          <div className="grid-3" style={{ marginBottom: 48 }}>
            {[
              { n: '01', t: 'Pembangunan Berkelanjutan', d: 'Sustainability and sustainable development — pembangunan yang seimbang antara kebutuhan manusia dan kelestarian ekosistem.' },
              { n: '02', t: 'Kelestarian Lingkungan', d: 'Environmental sustainability — menjaga fungsi ekosistem dan keanekaragaman hayati jangka panjang.' },
              { n: '03', t: 'Air, Sanitasi & Kesehatan Publik', d: 'UN Sustainable Development Goals — water, sanitation and public health untuk masyarakat wilayah tropis.' },
              { n: '04', t: 'Energi Bersih & Terbarukan', d: 'Clean, new and renewable energy — solusi rekayasa untuk transisi energi dan minimasi emisi karbon.' },
              { n: '05', t: 'Keamanan & Ketahanan Pangan', d: 'Food safety and security — aspek rekayasa lingkungan dalam rantai pasok pangan yang aman dan berkelanjutan.' },
              { n: '06', t: 'Mitigasi Perubahan Iklim', d: 'Climate change mitigation and adaptation — rekayasa teknik untuk ketangguhan ekosistem terhadap dampak iklim.' },
            ].map((item, i) => (
              <div key={item.n} className={`card vm-card-pad fade-up${i % 3 === 1 ? ' delay-1' : i % 3 === 2 ? ' delay-2' : ''}`}>
                <div style={{ fontFamily: 'var(--font-display)', fontSize: '2.8rem', color: 'rgba(78,140,90,0.15)', fontWeight: '300', marginBottom: 12 }}>{item.n}</div>
                <h3 style={{ fontFamily: 'var(--font-display)', fontSize: '1.05rem', color: 'var(--navy)', marginBottom: 10 }}>{item.t}</h3>
                <p style={{ fontSize: '0.8rem', color: 'rgba(45,58,46,0.55)', fontFamily: 'var(--font-body)', lineHeight: '1.7' }}>{item.d}</p>
              </div>
            ))}
          </div>

          {/* Penguasaan pengetahuan konkret */}
          <div className="fade-up delay-1">
            <div className="section-tag" style={{ marginBottom: 20 }}>— Penguasaan Pengetahuan Konkret</div>
            <div className="vm-list lg" style={{ maxWidth: 800 }}>
              {[
                'Pembuatan dan pelaksanaan rancangan teknik di bidang pengolahan dan penyaluran air minum, penyaluran dan pengolahan air limbah, pengelolaan sampah, kesehatan lingkungan, dan K3.',
                'Perencanaan dan pelaksanaan kegiatan pemantauan dan pengelolaan kualitas lingkungan untuk mencegah kerusakan lingkungan.',
                'Perencanaan dan pelaksanaan tindakan pengendalian pencemaran udara, air dan tanah.',
                'Perencanaan dan pelaksanaan upaya pencegahan dan pemulihan kerusakan lingkungan.',
                'Analisis dampak kegiatan dan valuasi lingkungan guna mendukung proses pengambilan keputusan yang berwawasan lingkungan.',
              ].map((item, i) => (
                <div key={i} className="vm-item lg">
                  <span className="vm-num-circle">{i + 1}</span>
                  {item}
                </div>
              ))}
            </div>
